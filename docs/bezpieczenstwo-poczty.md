...
5. Nigdy nie należy podawać nikomu swojego hasła.
6. Należy stosować trudne do odgadnięcia hasła:
   * warto zwrócić uwagę na odpowiednią długość oraz wykorzystanie znaków specjalnych,
...
Poniżej znajduje się przykład e-maila phishingowego, który z pozoru wydaje się nieszkodliwy:
